<h2><a href="https://leetcode.com/problems/hexadecimal-and-hexatrigesimal-conversion/?envType=problem-list-v2&envId=vyucb863">3602. Hexadecimal and Hexatrigesimal Conversion</a></h2><h3>Easy</h3><hr><p>You are given an integer <code>n</code>.</p>
