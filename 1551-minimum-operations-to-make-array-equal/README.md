<h2><a href="https://leetcode.com/problems/minimum-operations-to-make-array-equal/?envType=problem-list-v2&envId=v6cjxb81">1551. Minimum Operations to Make Array Equal</a></h2><h3>Medium</h3><hr><p>You have an array <code>arr</code> of length <code>n</code> where <code>arr[i] = (2 * i) + 1</code> for all valid values of <code>i</code> (i.e.,&nbsp;<code>0 &lt;= i &lt; n</code>).</p>
