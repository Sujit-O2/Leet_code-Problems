<h2><a href="https://leetcode.com/problems/license-key-formatting/?envType=problem-list-v2&envId=vyucb863">482. License Key Formatting</a></h2><h3>Easy</h3><hr><p>You are given a license key represented as a string <code>s</code> that consists of only alphanumeric characters and dashes. The string is separated into <code>n + 1</code> groups by <code>n</code> dashes. You are also given an integer <code>k</code>.</p>
