<h2><a href="https://leetcode.com/problems/maximum-twin-sum-of-a-linked-list/?envType=problem-list-v2&envId=v6cjxb81">2130. Maximum Twin Sum of a Linked List</a></h2><h3>Medium</h3><hr><p>In a linked list of size <code>n</code>, where <code>n</code> is <strong>even</strong>, the <code>i<sup>th</sup></code> node (<strong>0-indexed</strong>) of the linked list is known as the <strong>twin</strong> of the <code>(n-1-i)<sup>th</sup></code> node, if <code>0 &lt;= i &lt;= (n / 2) - 1</code>.</p>
